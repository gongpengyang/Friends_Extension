...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is Friends_Extension
                   DESC

  s.homepage     = "https://github.com/gongpengyang/Friends_Extension"
  ...
  s.source       = { :git => "https://github.com/gongpengyang/Friends_Extension.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Friends_Extension/Friends_Extension/**/*.{h,m,swift}"
